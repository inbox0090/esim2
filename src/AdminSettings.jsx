                ...
                <div key={f.label}>
                  ...
                  <div className="relative">
                    <input type={showKeys ? 'text' : 'password'} value={f.val} onChange={e => f.set(e.target.value)}
                      className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm bg-gray-50 font-mono focus:outline-none focus:ring-2 focus:ring-sky-400" />
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-2xl font-bold text-sky-600 w-14 text-right">{commission}%</span>
              </div>
              ...
              {[
                ...
                <div key={s.label} className="flex items-center justify-between">
                  ...
                  <button onClick={() => setToggles(prev => prev.map((v, i) => i === idx ? !v : v))}>
                    {toggles[idx] ? <ToggleRight size={28} className="text-sky-600"/> : <ToggleLeft size={28} className="text-gray-300"/>}
                  </button>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 col-span-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={b.label} className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-sky-300 transition cursor-pointer">
