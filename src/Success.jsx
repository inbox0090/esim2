...
import { CircleCheck as CheckCircle, Download, Smartphone, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-sm w-full">
        ...
        <div className="text-center mt-5">
          <Link to="/" className="text-sky-600 text-sm font-medium hover:underline flex items-center gap-1 justify-center">
