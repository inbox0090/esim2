      ...
      <div className="p-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-[10px] text-sky-500 font-medium uppercase tracking-wider">Admin Panel</div>
          </div>
        </div>
      </div>
  ...
  return (
    <Link to={item.path}
      className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-[13px] font-medium mb-0.5 transition-all group
        ${active ? 'bg-sky-50 text-sky-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
      <Icon size={16} className={active ? 'text-sky-600' : 'text-gray-400 group-hover:text-gray-600'} />
