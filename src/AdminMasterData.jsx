        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 mb-6">
          ...
          <div className="grid grid-cols-6 gap-3 items-end">
            <div className="col-span-1">
              ...
              <select className="w-full border border-gray-200 rounded-lg px-2 py-2.5 text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-400"
            ...
            <div className="col-span-1">
              ...
              <input className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-400"
            ...
            <div>
              ...
              <input type="number" step="0.01" className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-400"
            ...
            <div>
              ...
              <input type="number" className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-400"
                  ...
                  <tr key={p.id} className="border-t border-gray-50 hover:bg-gray-50 transition">
                    {editId === p.id ? (
                      ...
                      <>
                        ...
                        <td className="px-5 py-3"><span className="bg-sky-50 text-sky-700 text-[10px] font-semibold px-2 py-0.5 rounded-full">{p.region || 'Europe'}</span></td>
                        <td className="px-5 py-3 font-mono font-bold text-sky-600">{p.data} GB</td>
