...
import { Users, Smartphone, ShoppingBag, TrendingUp, CheckCircle, XCircle, Clock, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
        ...
        {/* Quick links */}
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-4 mb-6 flex items-center justify-between">
          <div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          {[
            ...
            { label: 'Visi pirkimai',          value: '31,204', delta: '+19.7%', up: true,  icon: ShoppingBag,  color: 'text-purple-600', bg: 'bg-purple-50' },
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-xs text-purple-600 font-medium hover:underline">Peržiūrėti visus →</button>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={usersData}>
                ...
                <YAxis tick={{ fontSize: 11 }} />
                <Tooltip />
                <Line type="monotone" dataKey="users" stroke="#8b5cf6" strokeWidth={2} dot={{ r: 4, fill: '#8b5cf6' }} name="Vartotojai" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            ...
            <button className="text-xs text-purple-600 font-medium hover:underline">Visi užsakymai →</button>
          </div>
                ...
                {recentOrders.map((o, i) => {
                  ...
                  return (
                    <tr key={o.id} className={`border-t border-gray-50 hover:bg-gray-50 transition ${i % 2 === 0 ? '' : 'bg-gray-50/30'}`}>
                      <td className="px-5 py-3 font-mono text-[11px] text-purple-600">{o.id}</td>
